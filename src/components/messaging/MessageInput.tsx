...
export function MessageInput({
  ...
  return (
    <div className="p-3 border-t border-border bg-background sticky bottom-0 z-10 pb-[env(safe-area-inset-bottom)]">
      {/* Reply/Edit Header */}
      {replyTo && (
      ...
      <div className="flex items-end space-x-2">
        ...
        <div className="flex-1 relative">
          ...
          <Textarea
            ...
            className="w-full resize-none transition-all duration-200 rounded-2xl min-h-[44px] max-h-[96px] overflow-y-auto pr-12"
            style={{ height: "auto" }}
            rows={1}
          />
